...
enum class OperationKind { ACTIVATE_GROUP, DEACTIVATE_GROUP, GRANT_DELEGATION, REVOKE_DELEGATION, CREATE_ACCOUNT, CREATE_INSTRUMENT, CANCEL_INSTRUMENT, START_RECURRENCE, STOP_RECURRENCE, WITHDRAW, REFUND }
