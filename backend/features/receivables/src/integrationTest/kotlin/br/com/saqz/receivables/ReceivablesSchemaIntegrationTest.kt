...
class ReceivablesSchemaIntegrationTest {
    ...
    fun `financial migration preserves manual data and validates on repeat`() {
        ...
        assertEquals(14, migration.migrate().migrationsExecuted)
        ...
        database.dataSource.connection.use {
            ...
            assertEquals(34, it.number("SELECT count(*) FROM information_schema.tables WHERE table_schema='public' AND table_name LIKE 'receivable_%'"))
        }
    }
