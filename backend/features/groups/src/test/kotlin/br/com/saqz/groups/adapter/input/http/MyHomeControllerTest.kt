            ...
            HomeAdminResponse(
                groups = listOf(
                    HomeAdminGroupResponse(
                        ...
                        name = "Grupo Praia",
                        entryRequestCount = 2,
                        monthlyCharges = HomeMonthlyChargesResponse(3, 450),
                        gameToSettle = HomeGameToSettleResponse(completedGame, now.minusSeconds(86_400), 2, 500),
                    ),
                ),
            ),
            response.admin,
                    ...
                    admin = HomeAdminReadModel(
                        groups = listOf(
                            HomeAdminGroup(
                                ...
                                name = "Grupo Praia",
                                entryRequestCount = 2,
                                monthlyCharges = HomeMonthlyCharges(3, 450),
                                gameToSettle = HomeGameToSettle(completedGame, now.minusSeconds(86_400), 2, 500),
                            ),
                        ),
                    ),
                )
