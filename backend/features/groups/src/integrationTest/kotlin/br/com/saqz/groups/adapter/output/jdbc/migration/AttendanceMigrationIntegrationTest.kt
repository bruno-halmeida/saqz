...
class AttendanceMigrationIntegrationTest {
    ...
    @Test fun `attendance member must belong to group`() { val f = fixture(); val outsider = user("outsider"); fails { attendance(f.copy(member = outsider), "DECLINED") } }
