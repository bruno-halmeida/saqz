...
data class Charge(val id:UUID,val groupId:UUID,val memberId:UUID,val identity:ChargeIdentity,val amountCents:Long,val dueDate:LocalDate,val status:ChargeStatus=ChargeStatus.PENDING,val version:Long=1,val reviewRequired:Boolean=false,val paidMethod:PaidMethod?=null,val guestDisplayName:String?=null){init{require(amountCents in 1..99_999_999);require(version>=1)}}
