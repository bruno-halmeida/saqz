...
- **Phase / Task**: Execute — Phase 8 / T55 (mobile attendance transport).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1594` — add mobile attendance DTOs and gateway.
- **Next step**: Execute T55 with exact own-attendance/count DTOs, self/override/capacity requests, command-key and ETag preservation, auth refresh, and distinct problem mapping.
