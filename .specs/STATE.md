...
- **Phase / Task**: Execute — Phase 6 / T41 (one-time/weekly game editor UI).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1155` — build the one-time/weekly game editor UI.
- **Next step**: Execute T41 with accessible one-time/weekly controls, multi-slot editing, explicit boundary scope, field errors, and compact/max-text coverage.
