...
- **Phase / Task**: Execute — Phase 5 / T36 (weekly series HTTP contracts).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1018` — expose weekly series and occurrence-boundary HTTP contracts.
- **Next step**: Execute T36 with local recurrence DTO round-trips, explicit boundary scopes, bounded results, privacy/stale problems, and Bruno contracts.
