...
- **Phase / Task**: Execute — Phase 7 / T53 (attendance HTTP contracts).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1531` — expose attendance self-service and organizer override HTTP contracts.
- **Next step**: Execute T53 with exact self/override/capacity DTOs, ETags, privacy-safe problems, authoritative counts, retry behavior, and Bruno coverage.
