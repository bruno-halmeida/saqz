...
- **Phase / Task**: Execute — Phase 6 / T39 (games list UI).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1099` — build upcoming/past games screens.
- **Next step**: Execute T39 with accessible cards, role-private drafts/CTA, loading/empty/error states, compact/max-text semantics, and 48 dp actions.
