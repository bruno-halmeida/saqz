...
- **Phase / Task**: Execute — Phase 6 / T40 (game editor ViewModel and drafts).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1124` — implement GameEditorViewModel and restorable drafts.
- **Next step**: Execute T40 with copied defaults, one-time/weekly validation, explicit edit scope, stable command keys/ETags, restart restoration, and conflict reload.
