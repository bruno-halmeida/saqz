...
- **Phase / Task**: Execute — Phase 7 / T48 (expense and finance totals HTTP API).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1387` — expose expense and finance-total HTTP contracts.
- **Next step**: Execute T48 with exact versioned expense DTOs/routes, privacy-safe problems, defined manual totals, audit history, and Bruno coverage.
