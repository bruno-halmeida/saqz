...
- **Phase / Task**: Execute — Phase 7 / T49 (attendance and waitlist migration).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1416` — add the attendance and waitlist migration.
- **Next step**: Execute T49 with constrained current attendance, monotonic per-game waitlist allocation, immutable override events, and PostgreSQL coverage.
