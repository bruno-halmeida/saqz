...
- **Phase / Task**: Execute — Phase 5 / T35 (one-time game lifecycle HTTP contracts).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:989` — expose one-time game and lifecycle HTTP contracts.
- **Next step**: Execute T35 with exact DTOs, privacy-equivalent problems, quoted ETags, lifecycle commands, rollback/replay coverage, and Bruno requests.
