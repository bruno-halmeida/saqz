...
- **Phase / Task**: Execute — Phase 6 / T37 (mobile game transport).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1047` — add mobile game/series DTOs and gateway.
- **Next step**: Execute T37 with exact serialization, stable request keys and ETags, derived read-only values, and distinct presentation-safe failures.
