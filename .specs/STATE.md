...
- **Phase / Task**: Execute — Phase 7 / T51 (atomic confirmation and waitlisting).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1471` — implement concurrency-safe confirmation and waitlisting.
- **Next step**: Execute T51 with a game-row lock, monotonic FIFO allocation, idempotent paid-game charge creation, rollback, and deterministic concurrency coverage.
