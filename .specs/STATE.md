...
- **Phase / Task**: Execute — Phase 5 / T31 (game values, snapshots, and lifecycle rules).
- **Completed**: T01 `49a4730`, T02 `024d689`, T03 `dfd35d8`, T08 `463dc86`, T09 `94ab9e8`, T13 `85d841b`, T14 `124250c`, T15 `d85ccb0`, T16 `e5fd6d3`, T17 `0946523`, T18, T19 `224136b`, T20 `edaa6c1`, T21 `7f5103f`, T22 `4ae41b7`, T23 `c132762`, T24 `45ea845`, T25 `3ed6ddc`, T26 `0566f97`, T27 `9d37f52`, T28 `bfbb4d2`, T29 `f2318dd`, and T30 games/series V4 relational migration. T30 backend full and safety gates passed with 31 added PostgreSQL cases covering V3 upgrade preservation, revision lineage, immutable slot/game snapshots, bounded occurrence identity, detached overrides, limits, deadlines, lifecycle values, and group-scoped foreign keys. Backprop evidence: the T30 environment failure is B28. The user-approved task amendment merged the former T03–T07 and T09–T12 incompatible dependency sequences.
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:874` — implement game values, default snapshots, and lifecycle rules.
- **Next step**: Execute T31 with game domain values and organizer lifecycle commands, unit coverage, backend quick, and safety gates.
