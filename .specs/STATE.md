...
- **Phase / Task**: Execute — Phase 7 / T43 (finance schema and migrations).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1224` — add finance persistence schema and migrations.
- **Next step**: Execute T43 with group-scoped monthly/game charges, manual payment records, expenses, append-only audit events, constraints, indexes, and PostgreSQL migration tests.
