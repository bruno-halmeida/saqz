...
- **Phase / Task**: Execute — Phase 7 / T52 (withdrawal, promotion, and capacity).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1501` — implement withdrawal, FIFO promotion, and capacity adjustment.
- **Next step**: Execute T52 with locked withdrawal/capacity commands, earliest-valid FIFO promotion, preserved withdrawal charges, and concurrent rollback coverage.
