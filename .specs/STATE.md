...
- **Phase / Task**: Execute — Phase 6 / T38 (games list ViewModel).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1072` — implement GamesViewModel.
- **Next step**: Execute T38 with selected-group isolation, upcoming/past state, organizer navigation, pt-BR presentation values, and single-flight effects.
