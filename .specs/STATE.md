...
- **Phase / Task**: Execute — Phase 7 / T46 (manual charge HTTP API).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1321` — expose charge query, generation, and status HTTP contracts.
- **Next step**: Execute T46 with organizer/athlete projections, stable monthly generation, versioned audited status updates, privacy-safe problems, and Bruno coverage.
