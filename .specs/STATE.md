...
- **Phase / Task**: Execute — Phase 7 / T47 (expense domain and persistence).
...
- **In-progress** (file:line): `.specs/features/group-management/tasks.md:1355` — implement expense domain, persistence, and audit.
- **Next step**: Execute T47 with exact expense validation, organizer-only privacy, optimistic JDBC writes, totals, append-only events, and rollback coverage.
