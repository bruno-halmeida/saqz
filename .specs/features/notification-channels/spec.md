...
## Aceitação
- AC1: adaptador usa UazapiClient de instância, sendText, telefone internacional sem `+`, trackId estável; 429 respeita Retry-After; 5xx/rede transitórios, demais 4xx permanentes. Aceitação pelo provedor não significa leitura/entrega.
