...
internal sealed interface AttendanceOperation {
    ...
    data class Override(val memberId:String,val intent:AttendanceIntent,val reason:String,override val key:String):AttendanceOperation
    data class Capacity(val capacity:Int,val version:AttendanceVersionToken,override val key:String):AttendanceOperation
}
