...
class FinanceViewModelTest {
    ...
    @Test fun `admin has organizer charge capabilities`()=runTest{val f=fixture(this,role=GroupRole.ADMIN);runCurrent();assertTrue(f.vm.state.value.organizer);assertEquals(1,f.organizer.chargeCalls);assertEquals(1,f.memberships.calls)}
