...
class FinanceTest {
    ...
    @Test fun `expense categories are complete`() = assertEquals(5, ExpenseCategory.entries.size)
    ...
    @Test fun `racha expense category is represented`() = assertEquals(ExpenseCategory.Racha, ExpenseCategory.entries[4])
