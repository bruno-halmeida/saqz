...
fun groupsPresentationModule(): Module = module {
    ...
    viewModel { params -> GroupDetailsViewModel(params.get(), get(), get()) }
    viewModel { params -> GroupMembersViewModel(params.get(), get(), get()) }
    viewModel { params -> GroupScheduleViewModel(params.get(), get()) }
}
